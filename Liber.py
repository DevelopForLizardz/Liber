...
class YTSong(object):
    ...
    def __init__(self, url, log=None):
        ...
        try:
            ...
            self.video = self._pafy.getbest(preftype="m4a")
        ...
        try:
            if os.path.exists(path) is False:
                ...
                if downloadType == ID_AUDIO:
                    ...
                    file_name = '/Youtube_Download-'+self.title+random_int+'.'
                    self.downloadPath = temp_path + file_name + self.audio.extension
                    ...
                    file_name = '/'+metadata['title']+random_int+"."
                    self.downloadPath = temp_path + file_name + self.video.extension
